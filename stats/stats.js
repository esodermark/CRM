document.addEventListener("DOMContentLoaded", function(e){
    ...
    document.getElementById("D").classList.add("btnActive");
    ...
    function addActive (btn) {
        let list = document.getElementsByClassName("btnActive");
        for (let element of list) {
          element.classList.remove("btnActive");
        }
        document.getElementById(btn).classList.add("btnActive")

        if(document.getElementById("D").classList[0] == "btnActive"){
